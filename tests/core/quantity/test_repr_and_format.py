...
# -------------------------------
# __repr__: Regression tests for cancellation + upgrade logic
...
def test_repr_regression_bug_fix_kg_mg_per_kg(monkeypatch):
    """
...
@pytest.mark.regression(reason="Issue #72: Quantity.__repr__ incorrectly upgrades a cancelled unit to a prefixed SI unit (e.g., mg becomes µkg)")
def test_repr_regression_cancellation_to_prefixed_si(monkeypatch):
    """
...
@pytest.mark.regression(reason="Issue #72: Quantity.__repr__ incorrectly upgrades a cancelled unit to a prefixed SI unit (e.g., mg becomes µkg)")
def test_repr_regression_cancellation_to_dimensionless(monkeypatch):
    """
...
@pytest.mark.regression(reason="Issue #72: Quantity.__repr__ incorrectly upgrades a cancelled unit to a prefixed SI unit (e.g., mg becomes µkg)")
def test_repr_regression_cancellation_to_si_symbol(monkeypatch):
    """
...
# -------------------------------
# __repr__: pretty printing (using _nop_prettifier)
# -------------------------------
